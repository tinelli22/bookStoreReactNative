...
function Info({ user, navigation, onLoadForm, valid, onSave, handleSubmit }) {
    ...
    return(
        <Layout>
            ...
            <Button block info disabled={!valid} onPress={handleSubmit(submit)}>
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        onSave: (uid,values) => dispatch(findUser(uid, values))
    }
}
